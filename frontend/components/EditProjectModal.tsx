...
import { X, Pencil, Loader2, ChevronDown, ChevronUp } from "lucide-react";
...
export default function EditProjectModal({ project, onClose, onSaved }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Only include transcript if it changed, to avoid accidentally clearing it
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
            ...
            {/* Transcript — collapsible since it can be long */}
            <div>
              <button
                type="button"
              ...
              {showTranscript && (
                <textarea
                  ...
                  rows={10}
                  className={`mt-2 font-mono resize-none ${inputClass}`}
